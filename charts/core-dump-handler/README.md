...
* CRIO_ENDPOINT - The CRIO endpoint to use.
    ...
    "unix:///var/run/dockershim.sock": Use for nodes still using dockershim
...
* MATCH_LABEL - Optional label name to check for before triggering the core dump collection.
